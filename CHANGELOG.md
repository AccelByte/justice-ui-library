...
## [0.15.0]
### Chore
- Remove third party deps from bundle by marking them as `externals` in rollup config

## [0.14.7]
### Fixed
- revert change in version 0.13.8 related with validation copy/paste with letter e

## [0.14.6]
### Refactored
- add prop to able manual input in `DateTimePicker` component
...
## [0.14.3]
### Added
- added prop `formatOptionLabel` in `ValidMultiSelect`
